      ...
      <Pressable onPress={() => onPress(user.id as string)}>
        <View key={user.phone} style={styles.container}>
          ...
          <View style={styles.cardContent}>
            ...
            <Text numberOfLines={2} style={styles.aboutMe}>
              {user.aboutMe}
            </Text>
            {user.street && (
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20 },
  aboutMe: { marginBottom: 5, color: colors.textSecondary },
  location: { marginBottom: 5, width: '95%', flexDirection: 'row', alignItems: 'center' },
