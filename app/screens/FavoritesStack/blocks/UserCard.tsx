...
interface IProps {
  user: IProfileForm
  onPress: (arg0: { masterId: string }) => void
}
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20 },
  aboutMe: {},
  location: { width: '90%', flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
  locationText: {},
  photoGallery: {},
